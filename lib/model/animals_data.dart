class AnimalsData {
  String name, image, location, desc, donateLink;
  List imageList;

  AnimalsData({
    /// Agar tetap berjalan dengan null safety, init data awal = wajib
    this.name = "",
    this.image = "",
    this.location = "",
    this.desc = "",
